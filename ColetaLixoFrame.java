...
public class ColetaLixoFrame extends JFrame {
    ...
    int caminhoesPorTipo;
    int[] caminhoesCapacidades;
    int horarioInicio;
    int horarioFim;
    ...
    public ColetaLixoFrame(ConfiguracaoSimulacao configuracao) {
        this.caminhoesPorTipo = configuracao.getCaminhoesPorTipo();
        this.caminhoesCapacidades = configuracao.getCaminhoesCapacidades();
        ...
        for (int capacidade : caminhoesCapacidades) {
            for (int i = 1; i <= caminhoesPorTipo; i++) {
    ...
    void mostrarRelatorio() {
        ...
        sb.append("\n🔋 Quantidade de Caminhões Pequenos Visitados nas Zonas:\n");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ConfiguracaoSimulacao config = new ConfiguracaoSimulacao(
                10, // caminhões por tipo
                new int[]{2, 4, 8, 10}, // capacidades
                5 * 60, // início (05:00)
                23 * 60 // fim (23:00)
            );
            new ColetaLixoFrame(config);
        });
    }
}